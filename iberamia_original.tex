...
Este documento incluye la guía de edición de artículos de la revista, con la intención de que todos los artículos tengan un formato uniforme. La revista no se puede hacer cargo de la edición final del artículo. También se incluyen algunas recomendaciones útiles para la correcta edición del articulo. Es obligatorio que cada articulo incluya  un resumen en español y un abstract en ingles. La lista de palabras clave (Keywords) debe estar en ingles, aunque se puede incluir también en español, si los autores lo consideran oportuno.}}
