...
\begin{table}[hb]
	\begin{center}
		{\caption{Chi Squared Results (lower value is better).}\label{tab:localchi}}
...
\begin{table}[hb]
	\begin{center}
		{\caption{Total Variation \%(lower value is better).}\label{tab:localtotal}}
		\begin{tabular}{|l|l|l|}\hline
			&\textbf{PAQ8L} & \textbf{RNN}\\ \hline
...
\begin{table}[hb]
	\begin{center}
		{\caption{Jaccard Similarity (higher is better).}\label{tab:localjaccard}}
		\begin{tabular}{|l|l|l|}\hline
			&\textbf{PAQ8L} & \textbf{RNN}\\ \hline
...
\begin{table}[hb]
	\begin{center}
		{\caption{Chi Squared Results (lower value is better).}\label{tab:globalchi}}
		\begin{tabular}{|l|l|l|}\hline
			&\textbf{PAQ8L} & \textbf{RNN}\\ \hline
...
\begin{table}[hb]
	\begin{center}
		{\caption{Total Variation \%(lower value is better).}\label{tab:globaltotal}}
		\begin{tabular}{|l|l|l|}\hline
			&\textbf{PAQ8L} & \textbf{RNN}\\ \hline
...
\begin{table}[hb]
	\begin{center}
		{\caption{Jaccard Similarity (higher is better).}\label{tab:globaljaccard}}
		\begin{tabular}{|l|l|l|}\hline
			&\textbf{PAQ8L} & \textbf{RNN}\\ \hline
